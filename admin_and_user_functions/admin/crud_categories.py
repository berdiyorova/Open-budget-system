...
def create_category():
    if show_all_project_types():
        project_type_id = int(input("Enter project type id:  "))
...
def show_categories_by_project_type():
    if show_all_project_types():
        project_type_id = int(input("Choose project type id:  "))
...
def update_the_category():
    if show_all_categories():
        id = int(input("Enter category id you want to update:  "))
...
def update_project_type_id(id):
    if show_all_project_types():
        project_type_id = int(input("Change project type id:  "))
...
def delete_category_from_table():
    if show_all_categories():
        id = int(input("Enter category id you want to delete:  "))
